...
class HomeHeader extends Component {
    ...
    handleChangeSelectDoctorInfor=async(selectedOption,name)=>{
        ...
        this.props.history.push(`/detail-specialty/${stateCopy.selectedSpecialty.value}`)
    }
                    ...
                    <div className="home-header-content">
                        ...
                        <div className="center-content">
                            ...
                            >
                                ...
                                <div className="subs-title"><FormattedMessage id="homeheader.golden-notebook"/></div>
                            </div>
                        </div>
                                ...
                                <div className="row">
                                    <div className="col-6 form-group">
                                        <Select
                                            ...
                                            placeholder={<FormattedMessage id="admin.manage-doctor.search"/>}
